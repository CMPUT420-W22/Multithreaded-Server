...
if you were to run make, the all function is called. Then the executables, singleMutexServer, multMutexServer, singleReadServer, mutexReadServer, client, and attacker will be made. 
